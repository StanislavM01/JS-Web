function UserTableRow({ user, clickOnUserButtons }) {
    return (
        <tr>
            <td>
            ...
            <td className="actions">
                <button className="btn edit-btn" title="Edit" onClick={() => clickOnUserButtons(user._id,'edit')}>
                ...
                <button className="btn delete-btn" title="Delete" onClick={() => clickOnUserButtons(user._id,'delete')}>
                ...
                <button className="btn info-btn" title="Info" onClick={() => clickOnUserButtons(user._id,'details')}>
