      ...
      <section id="edit-page" className="auth">
        <form id="edit">
          <div className="container">
            <h1>Edit Game</h1>
            <label htmlFor="leg-title">Legendary title:</label>
            <input type="text" id="titleTwo" name="title" defaultValue />
            <label htmlFor="category">Category:</label>
            <input type="text" id="categoryTwo" name="category" defaultValue />
            <label htmlFor="levels">MaxLevel:</label>
            <input type="number" id="maxLevelTwo" name="maxLevel" min={1} defaultValue />
            <label htmlFor="game-img">Image:</label>
            <input type="text" id="imageUrlTwo" name="imageUrl" defaultValue />
            <label htmlFor="summary">Summary:</label>
            <textarea name="summary" id="summaryTwo" defaultValue={""} />
